...
print ( "Starting poll-ina219-power-HAT.py " )
...
if __name__=='__main__':
    ...
    myRRDData = (bus_voltage1 + shunt_voltage1)

    filename = "/home/sysadmin/offgrid/data/device-ina219-power-HAT-01-volts.rrd"
    ...
    myRRDData = (current1/1000)

    filename = "/home/sysadmin/offgrid/data/device-ina219-power-HAT-01-current.rrd"
...
###################################################
    ...
    filename = "/home/sysadmin/offgrid/data/device-ina219-power-HAT-01-power.rrd"
   ...
   ###################################################
    ...
    myRRDData = (bus_voltage2 + shunt_voltage2)

    filename = "/home/sysadmin/offgrid/data/device-ina219-power-HAT-02-volts.rrd"
    ...
    myRRDData = (current2/1000)

    filename = "/home/sysadmin/offgrid/data/device-ina219-power-HAT-02-current.rrd"
...
###################################################
    ...
    filename = "/home/sysadmin/offgrid/data/device-ina219-power-HAT-02-power.rrd"
    ...
    if( myRRDData != 'NULL' ):
            ...
            os.system('/usr/bin/rrdtool update '+filename+" "+str(myRRDLogTime)+':'+str(myRRDData))
            print ( "done" )
    print ( "Exiting poll-ina219-power-HAT.py ")
